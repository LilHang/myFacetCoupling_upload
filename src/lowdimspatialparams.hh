...
: public FVPorousMediumFlowSpatialParamsMP< GridGeometry, Scalar, LowDimSpatialParams<GridGeometry, Scalar> >
{
...
public:
    ...
    LowDimSpatialParams(std::shared_ptr<const GridGeometry> gridGeometry, const std::string& paramGroup)
    : ParentType(gridGeometry)
    , pcKrSwCurve_("LowDim.SpatialParams")
    {
